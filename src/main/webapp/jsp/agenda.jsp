                                                        ...
                                                        <div class="card-body">
                                                            <% if (lista.isEmpty()) { %>
                                                                <div class="alert alert-info">
                                                                    <i class="fas fa-info-circle"></i> Non hai ancora
                                                                    appuntamenti.
                                                                </div>
                                                                <% } else { %>
                                                                    <div class="table-responsive">
                                                                        <table class="table table-striped">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th><i class="fas fa-calendar"></i>
                                                                                        Data e Ora</th>
                                                                                    <th><i class="fas fa-heading"></i>
                                                                                        Titolo</th>
                                                                                    <% if
                                                                    ...
                                                                    <% } %>
                                                                        ...
                                                                        <div class="mb-3 form-check">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                <%=editMode && appuntamentoEdit !=null
