...
<%
    ...
    boolean isAdmin = utente.getRuolo() != null && utente.getRuolo().equalsIgnoreCase("admin");
%>
<!DOCTYPE html>
<html lang="it">
<head>
...
<div class="container-fluid">
    ...
    <div class="row bg-primary text-white py-3">
        ...
        <div class="col-auto">
            <span class="me-3">
                <i class="fas fa-user"></i> <%= utente.getUsername() %>
                <% if (isAdmin) { %>
                    ...
                    <div class="card-body">
                        ...
                        <% } else { 
                            for (Invito invito : invitiRicevuti) { 
                                String stato = invito.getStato();
                                String borderClass = "warning";
                                if ("accettato".equals(stato)) borderClass = "success";
                                else if ("rifiutato".equals(stato)) borderClass = "danger";
                                String statoBadge = "N/A";
                                if ("in_attesa".equals(stato)) statoBadge = "In attesa";
                                else if ("accettato".equals(stato)) statoBadge = "Accettato";
                                else if ("rifiutato".equals(stato)) statoBadge = "Rifiutato";
                        %>
                        <div class="card mb-3 border-<%= borderClass %>">
                            <div class="card-body">
                                <h6 class="card-title">
                                    <%= invito.getTitoloAppuntamento() %>
                                    <span class="badge bg-<%= borderClass %>"><%= statoBadge %></span>
                                </h6>
                                <p>
                                    <strong>Da:</strong> <%= invito.getUsernameMittente() %><br>
                                    <strong>Data:</strong>
                                    <%= invito.getDataAppuntamento() != null ?
                                        new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm").format(invito.getDataAppuntamento()) : "N/A" %><br>
                                    <% if (invito.getDescrizione() != null && !invito.getDescrizione().isEmpty()) { %>
                                        <strong>Descrizione:</strong> <%= invito.getDescrizione() %><br>
                                    <% } %>
                                    <% if (invito.getMessaggio() != null && !invito.getMessaggio().isEmpty()) { %>
                                        <strong>Messaggio:</strong> <%= invito.getMessaggio() %><br>
                                    <% } %>
                                </p>
                                <% if (invito.isPending()) { %>
									<% if (invito.isPending()) { %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-3 border-<%= borderClass %>">
                            <div class="card-body">
                                ...
                                <p>
                                    <strong>A:</strong> <%= invito.getUsernameDestinatario() %><br>
                                    <strong>Data:</strong>
                                    <%= invito.getDataAppuntamento() != null ?
                                        new java.text.SimpleDateFormat("dd/MM/yyyy HH:mm").format(invito.getDataAppuntamento()) : "N/A" %><br>
                                    <% if (invito.getDescrizione() != null && !invito.getDescrizione().isEmpty()) { %>
                    ...
                    <div class="card-body">
                        <form method="post" action="<%= request.getContextPath() %>/inviti">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="username" class="form-label">Username Destinatario</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="titolo" class="form-label">Titolo Appuntamento</label>
                                        <input type="text" class="form-control" name="titolo" id="titolo"
                                               placeholder="Titolo dell'appuntamento" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
